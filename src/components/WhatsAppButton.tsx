...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-[200] flex h-14 w-14 items-center justify-center rounded-full bg-wa shadow-[0_4px_16px_rgba(37,211,102,0.45)] transition-transform hover:scale-105"
    >
